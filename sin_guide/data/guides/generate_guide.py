...
a1_ids["grelwood_03"] = add_step(1, "The Grelwood", "(Optional) Kill Gerung, the Brambleghast: Level 1 Uncut Skill Gem drop", "kill", "Gerung, the Brambleghast", "", ["optional"], [])
...
a1_ids["grim_tangle_02"] = add_step(1, "The Grim Tangle", "(Optional) Kill Ervig, Rotted Druid: Uncut Support Gem", "kill", "Ervig, Rotted Druid", "", ["optional"], [])
...
a1_ids["ogham_manor_02"] = add_step(1, "Ogham Manor", "Defeat Count Geonor", "kill", "Count Geonor", "", ["mandatory"], [])
...
a2_ids["halani_gates_06"] = add_step(2, "The Halani Gates", "Defeat Jamanra, the Risen King", "kill", "Jamanra, the Risen King", "", ["mandatory"], [])
...
a2_ids["dreadnought_02"] = add_step(2, "The Dreadnought", "Locate and defeat Jamanra, the Abomination", "kill", "Jamanra, the Abomination", "Boss is found in the depths of the Dreadnought", ["mandatory"], [])
...
a3_ids["jungle_ruins_04"] = add_step(3, "Jungle Ruins", "(Optional - Recommended) Enter the Venom Crypts for a permanent buff reward", "travel", "The Venom Crypts", "Side zone off Jungle Ruins — optional but gives a permanent buff choice", ["optional", "recommended"], [], {"type": "enter_area", "target_area": "The Venom Crypts"})
a3_ids["venom_crypts_01"] = add_step(3, "The Venom Crypts", "Locate the Den of the Serpent Priestess and Loot the Corpse-snake Venom", "loot", "Corpse-snake Venom", "", ["optional", "recommended"], [])
a3_ids["ziggurat_03"] = add_step(3, "Ziggurat Encampment", "Portal to Town. Give the Corpse-snake Venom to Servi", "quest_reward", "Servi", "Choose a permanent buff reward. WARNING: This cannot be changed later!", ["optional", "recommended"], [])
...
a3_ids["infested_barrens_04"] = add_step(3, "Infested Barrens", "Hug the outside wall to locate the exit to Chimeral Wetlands", "travel", "Chimeral Wetlands", "", ["mandatory"], [], {"type": "enter_area", "target_area": "Chimeral Wetlands"})
a3_ids["chimeral_wetlands_01"] = add_step(3, "Chimeral Wetlands", "Activate the Waypoint and navigate Chimeral Wetlands", "travel", "Chimeral Wetlands", "", ["mandatory"], [])
...
a3_ids["jiquani_sanctum_04"] = add_step(3, "Jiquani's Sanctum", "Defeat Zicoatl, Warden of the Core", "kill", "Zicoatl, Warden of the Core", "", ["mandatory"], [])
a3_ids["jiquani_sanctum_05"] = add_step(3, "Jiquani's Sanctum", "Loot the Large Soul Core dropped by Zicoatl", "loot", "Large Soul Core", "", ["mandatory"], [])
a3_ids["jungle_ruins_05"] = add_step(3, "Jungle Ruins", "Return to Jungle Ruins. Use the Large Soul Core on the Stone Altar to resurface Matlan Waterways", "travel", "Jungle Ruins", "", ["mandatory"], [])
a3_ids["matlan_01"] = add_step(3, "Matlan Waterways", "Enter the Matlan Waterways", "travel", "Matlan Waterways", "", ["mandatory"], [], {"type": "enter_area", "target_area": "Matlan Waterways"})
a3_ids["matlan_02"] = add_step(3, "Matlan Waterways", "Navigate the flooded canals toward the lever at the far end", "travel", "", "", ["mandatory"], [])
a3_ids["matlan_03"] = add_step(3, "Matlan Waterways", "(Optional) Inspect the Ravaged Corpse for random loot", "loot", "Ravaged Corpse", "", ["optional"], [])
a3_ids["matlan_04"] = add_step(3, "Matlan Waterways", "(Optional) Enter The Azak Bog via the Bog Entrance for a Permanent Buff", "travel", "The Azak Bog", "", ["optional"], [], {"type": "enter_area", "target_area": "The Azak Bog"})
a3_ids["azak_bog_01"] = add_step(3, "The Azak Bog", "Summon and speak to Servi, if needed", "quest_reward", "Servi", "", ["optional"], [])
a3_ids["azak_bog_02"] = add_step(3, "The Azak Bog", "(Optional) Complete the Flameskin Ritual for temporary Fire Resistance boost", "quest_reward", "", "Only if your Fire Resistance is very low (below 30-40%)", ["optional"], [])
a3_ids["azak_bog_03"] = add_step(3, "The Azak Bog", "(Permanent Buff) Defeat Ignagduk, the Bog Witch: Gemrot Skull — +30 Spirit, Uncut Spirit Gem Level 10", "kill", "Ignagduk, the Bog Witch", "", ["permanent_buff"], [])
a3_ids["matlan_05"] = add_step(3, "Matlan Waterways", "Pull the lever to resurface. Return to Ziggurat Encampment", "travel", "Ziggurat Encampment", "", ["mandatory"], [], {"type": "enter_area", "target_area": "Ziggurat Encampment"})
a3_ids["ziggurat_05"] = add_step(3, "Ziggurat Encampment", "Speak to Alva and Oswald", "quest_reward", "", "", ["mandatory"], [])
...
a3_ids["molten_vault_01"] = add_step(3, "The Molten Vault", "Defeat Mektul, the Forgemaster", "kill", "Mektul, the Forgemaster", "", ["mandatory"], [])
...
a3_ids["apex_filth_01"] = add_step(3, "The Apex of Filth", "Defeat Queen of Filth", "kill", "Queen of Filth", "", ["mandatory"], [])
a3_ids["apex_filth_02"] = add_step(3, "The Apex of Filth", "Interact with the Temple Door idol to unlock the path forward", "loot", "Temple Door idol", "", ["mandatory"], [])
a3_ids["temple_kopec_01"] = add_step(3, "Temple of Kopec", "Enter the Temple of Kopec", "travel", "Temple of Kopec", "", ["mandatory"], [], {"type": "enter_area", "target_area": "Temple of Kopec"})
a3_ids["temple_kopec_02"] = add_step(3, "Temple of Kopec", "Navigate through the Temple of Kopec", "travel", "", "", ["mandatory"], [])
a3_ids["temple_kopec_03"] = add_step(3, "Temple of Kopec", "Defeat Ketzuli, High Priest of the Sun", "kill", "Ketzuli, High Priest of the Sun", "", ["mandatory"], [])
a3_ids["temple_kopec_04"] = add_step(3, "Temple of Kopec", "Claim the quest reward from Ketzuli's defeat", "quest_reward", "", "", ["mandatory"], [])
a3_ids["utzaal_01"] = add_step(3, "Utzaal of the Past", "Enter Utzaal of the Past", "travel", "Utzaal of the Past", "", ["mandatory"], [], {"type": "enter_area", "target_area": "Utzaal of the Past"})
a3_ids["utzaal_02"] = add_step(3, "Utzaal of the Past", "Navigate through Utzaal of the Past", "travel", "", "", ["mandatory"], [])
a3_ids["utzaal_03"] = add_step(3, "Utzaal of the Past", "(Optional) Locate the Sacrificial Heart: Rare Jewel", "loot", "Sacrificial Heart", "", ["optional"], [])
a3_ids["utzaal_04"] = add_step(3, "Utzaal of the Past", "Defeat Viper Napuatzi", "kill", "Viper Napuatzi", "", ["mandatory"], [])
a3_ids["utzaal_05"] = add_step(3, "Utzaal of the Past", "Claim the quest reward from Viper Napuatzi's defeat", "quest_reward", "", "", ["mandatory"], [])
a3_ids["aggorat_01"] = add_step(3, "Aggorat of the Past", "Enter Aggorat of the Past", "travel", "Aggorat of the Past", "", ["mandatory"], [], {"type": "enter_area", "target_area": "Aggorat of the Past"})
a3_ids["aggorat_02"] = add_step(3, "Aggorat of the Past", "(Optional) Perform the Blood Sacrifice ritual: +2 Weapon Set Passive Skill Points", "quest_reward", "Blood Sacrifice", "", ["optional"], [])
a3_ids["black_chambers_01"] = add_step(3, "The Black Chambers of the Past", "Enter The Black Chambers of the Past", "travel", "The Black Chambers of the Past", "", ["mandatory"], [], {"type": "enter_area", "target_area": "The Black Chambers of the Past"})
a3_ids["black_chambers_02"] = add_step(3, "The Black Chambers of the Past", "Defeat Doryani, Royal Thaumaturge", "kill", "Doryani, Royal Thaumaturge", "", ["mandatory"], [])
a3_ids["black_chambers_03"] = add_step(3, "The Black Chambers of the Past", "Act 3 complete: portal back to Ziggurat Encampment", "travel", "Ziggurat Encampment", "", ["mandatory"], [])
