...
class SinGuideApp(QObject):
    ...
    def _init_components(self):
        ...
        # Derive the exports dir from ConfigManager so it honors
        # XDG_CONFIG_HOME — inside the Flatpak sandbox a hardcoded
        # ~/.config is not mounted and writes there do not persist.
